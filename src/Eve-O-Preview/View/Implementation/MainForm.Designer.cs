...
namespace EveOPreview.View
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			ContentTabControl.Size = new Size(650, 418);
			...
			GeneralTabPage.Size = new Size(522, 410);
			...
			AnimationStyleCombo.Location = new Point(150, 155);
			...
			ThumbnailTabPage.Size = new Size(522, 410);
			...
			PreventPreviewColorButton.Location = new Point(311, 280);
			...
			ThumbnailsWidthNumericEdit.Location = new Point(174, 60);
			...
			ThumbnailsHeightNumericEdit.Location = new Point(174, 107);
			...
			ZoomTabPage.Size = new Size(522, 410);
			...
			ZoomSettingsPanel.Size = new Size(522, 410);
			...
			ZoomAnchorPanel.Location = new Point(134, 103);
			...
			ThumbnailZoomFactorNumericEdit.Location = new Point(134, 60);
			...
			OverlayTabPage.Size = new Size(522, 410);
			...
			ActiveClientHighlightColorButton.Size = new Size(153, 30);
			...
			ClientsTabPage.Size = new Size(522, 410);
			...
			ClientsPanel.Size = new Size(522, 410);
			...
			ThumbnailsList.Location = new Point(0, 64);
			...
			AboutTabPage.Size = new Size(522, 410);
			...
			AboutPanel.Size = new Size(522, 410);
